...
import org.continuent.appia.core.events.channel.ChannelEvent;
...
public class Event {
   ...
   * {@link org.continuent.appia.core.Channel Channel} to which it belongs,
   * the {@link org.continuent.appia.core.Direction Direction} it will take, or the
   * {@link org.continuent.appia.core.Session Session} that generated it.
   * <br>
   * All these attributes must be set, before the event is
   * {@link org.continuent.appia.core.Event#init initialized}.
   */
  public Event() {
  }
   ...
   * @param src the {@link org.continuent.appia.core.Session Session} that is generating the Event
   * @throws AppiaEventException as the result of calling
   * {@link org.continuent.appia.core.Event#init init()}
   */
