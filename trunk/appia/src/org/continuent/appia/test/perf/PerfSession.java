...
//      }
  ...
  private void sendDebug(Channel channel) {
    try {
      org.continuent.appia.core.events.channel.Debug e = new org.continuent.appia.core.events.channel.Debug(debug);
      ...
      e.init();
      e.go();
    } catch (org.continuent.appia.core.AppiaEventException ex) {
      ex.printStackTrace();
