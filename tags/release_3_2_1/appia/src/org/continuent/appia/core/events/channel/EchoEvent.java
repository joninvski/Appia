...
/**
 * An <i>EchoEvent</i> is the carrier for an {@link org.continuent.appia.core.Event Event} that will
 * be bounced of the edges of the stack.
 * <br>
 * In other words, the payload {@link org.continuent.appia.core.Event Event} of an <i>EchoEvent</i>
 ...
 * {@link org.continuent.appia.core.Channel#handle Channel.handle(Event)} method, which is called
 * when a {@link org.continuent.appia.core.events.channel.ChannelEvent ChannelEvent} reaches any of
 * the ends of the {@link org.continuent.appia.core.Channel Channel} stack.
 *
 * @author Alexandre Pinto
 * @version 0.1
 * @see org.continuent.appia.core.Channel#handle
 */
public class EchoEvent extends ChannelEvent {
   ...
   *
   * @param event the payload {@link org.continuent.appia.core.Event Event}
   ...
   * {@link org.continuent.appia.core.events.channel.ChannelEvent#ChannelEvent(Channel,int,Session,int)
  ...
  /**
   * Get the payload {@link org.continuent.appia.core.Event Event}.
   *
   * @return the payload {@link org.continuent.appia.core.Event Event}
   */
