...
/**
 * Thrown when the desired {@link org.continuent.appia.core.QoS QoS} is invalid.
 * <br>
 * This is normally due to some {@link org.continuent.appia.core.Event Event} that is <i>required</i>
 * by some {@link org.continuent.appia.core.Layer Layer}, but no other {@link org.continuent.appia.core.Layer Layer}
 * <i>provides</i> it.
 *
