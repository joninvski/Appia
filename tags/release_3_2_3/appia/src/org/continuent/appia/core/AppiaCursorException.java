...
/**
 * Thrown when an exception ocurs in {@link org.continuent.appia.core.ChannelCursor ChannelCursor}
 * manipulation.
 *
...
public class AppiaCursorException extends AppiaException {
  ...
  /**
   * Tried to get the {@link org.continuent.appia.core.Session Session} bellow,
   * but it is already at the bottom of the stack.
   */
  public static final int CURSORONBOTTOM=2;
  /**
   * Tried to get the {@link org.continuent.appia.core.Session Session} above,
   * but it is already at the top of the stack.
   */
  public static final int CURSORONTOP=3;
  /**
   * Tried to set an already set {@link org.continuent.appia.core.Session Session}
   */
  public static final int ALREADYSET=4;
  /**
   * Tried to set a {@link org.continuent.appia.core.Session Session} of the wrong
   * {@link org.continuent.appia.core.Layer Layer}
   */
   ...
   *
   * @param type the {@link org.continuent.appia.core.AppiaCursorException#type type} of the exception
   */
