...
/**
 * {@link org.continuent.appia.protocols.group.events.GroupEvent GroupEvent} that notifies that
 * one, or more, members of the group have failed.
 * <br>
 * The Event is sent by the
 * {@link org.continuent.appia.protocols.group.suspect.SuspectLayer suspect layer} and contains a
 * bolleans array, of the same
 * {@link org.continuent.appia.protocols.group.ViewState#view size of the current view}. Each
 * postion in the boolean array corresponds to the same position in the
 * {@link org.continuent.appia.protocols.group.ViewState#view view array}. All the members
...
public class Fail extends GroupEvent implements Cloneable {
   ...
   * {@link org.continuent.appia.protocols.group.events.GroupEvent Event}
   * with the given array of failed members.
   * <br>
   * It calls
   * {@link org.continuent.appia.protocols.group.events.GroupEvent#GroupEvent(Group,ViewID)
