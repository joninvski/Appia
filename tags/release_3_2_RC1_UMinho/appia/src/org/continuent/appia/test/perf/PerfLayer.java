...
package org.continuent.appia.test.perf;
...
public class PerfLayer extends Layer {
  ...
  public PerfLayer() {
    Class perfcast=org.continuent.appia.test.perf.PerfCastEvent.class;
    Class perfsend=org.continuent.appia.test.perf.PerfSendEvent.class;
    ...
    evProvide=new Class[] {
        perfcast,
        perfsend,
        org.continuent.appia.protocols.group.events.GroupInit.class,
        rse,
        org.continuent.appia.protocols.group.leave.LeaveEvent.class,
        PerfTimer.class,
    };
