...
public class QoS {
  ...
  public QoS(String ID, Layer[] layers) throws AppiaInvalidQoSException {
    ...
    //gathers provided and accepted events of the channel
      provided.add(org.continuent.appia.core.events.channel.ChannelInit.class);
      provided.add(org.continuent.appia.core.events.channel.ChannelClose.class);
      eventsAccepted[eventsAccepted.length-1]=new Class[1];
      eventsAccepted[eventsAccepted.length-1][0]=org.continuent.appia.core.events.channel.ChannelEvent.class;
