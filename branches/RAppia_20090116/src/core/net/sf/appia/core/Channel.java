...
public class Channel {
    ...
    public void start() throws AppiaDuplicatedSessionsException {
        ...
        registerChannel(channelID, this);
    ...
    public void handle(Event event) {
       ...
       // System.out.println("Handle channel " + event.getClass().getCanonicalName());
        // ChannelInit
    ...
    if ( event instanceof AsyncEvent ) {
      return;
        ...
        //Adaptation Event
        //Cristina - Março de 2009
        //Adicionei este caso para que os eventos de adaptação sejam entregues ao ReconfiguratorManager
        if (event instanceof RecActionEvent){         
            Appia.appia.rappiaInterpreter.handle((RecActionEvent) event);
    ...
    private void registerChannel(String id, Channel channel){
        System.out.println("Registering channel in Appia...");
        Appia.appia.channelList.put(id, channel);
        System.out.println(Appia.appia.getChannels().size());
        Appia.appia.rappiaInterpreter.updateChannelList(channel);
        Appia.appia.updateChannelList(channel);
    }
