...
public class QoS {
    ...
    protected void exportLayersInfo(){
        int i,j;
        ...
        for (i=0 ; i < layers.length ; i++) {
           ...
           // System.out.println("+++++++++ " + l.getClass().getSuperclass());
            ...
            if(l.getClass().getSuperclass().equals(ServiceType.class)){
                System.out.println("SERVICE TYPE : " + l.getClass().getName());

            //add state to interpreter -> é preciso? o interpreter pode logo sacar o estado com base na referência da layer
           // ServiceType s = (ServiceType) l;
            //System.out.println("AdaptableParams" + s.getAddaptableParams().toString());
            //System.out.println("RequiredServiceTypes" + s.getRequiredServiceTypes().toString());
