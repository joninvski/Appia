...
import net.sf.appia.adaptationmanager.AdaptationManagerLayer;
import net.sf.appia.adaptationmanager.AdaptationManagerSession;
...
public class AdaptationManager {
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
		    ...
		    final Channel myChannel=myQoS.createUnboundChannel("Control Channel");
		    ...
		    final AdaptationManagerSession ams=(AdaptationManagerSession)qos[qos.length-1].createSession();
		    try {
				ams.init(
						localport,
